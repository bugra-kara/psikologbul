            ...
            <div className='flex w-full items-center justify-center py-10 px-2'>
                  <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 sm:gap-20 place-items-center'>
                        <div className='col-span-1 rounded-lg p-5 shadow-[0_0px_15px_0px_rgba(131,144,250,0.35)] h-fit w-56 sm:w-auto'>
                              <span className='justify-center flex pb-3 font-bold text-sm items-center space-x-2'><span className=' text-palatte-8'><BsPeople/></span><span className=' text-palatte-1'>Görüşme tercihiniz</span></span>
                        ...
                        <div className='col-span-1 rounded-lg p-5 shadow-[0_0px_15px_0px_rgba(131,144,250,0.35)] h-fit'>
                              <span className='justify-center flex pb-3 font-bold text-sm items-center space-x-2'><span className=' text-palatte-5'><MdOutlineLocationOn/></span><span className=' text-palatte-1'>Şehir seçiniz</span></span>
                              <Selection className='w-48' options={cities} placeholder="Şehir" onChange={handleChange}></Selection>
                        </div>
                        <div className='col-span-1 rounded-lg p-5 shadow-[0_0px_15px_0px_rgba(131,144,250,0.35)] h-fit'>
                              <span className='justify-center flex pb-3 font-bold text-sm items-center space-x-2'><span className=' text-palatte-6'><RiPsychotherapyLine/></span><span className=' text-palatte-1'>Kimin için</span></span>
